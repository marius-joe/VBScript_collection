...
Dim objProcessList
	...
	If objArgs.Count = 0 Then
        strMsg = "Please enter program name or full program path."
        path_program = LCase(InputBox(strMsg, "Exit Program"))
        isInputName = True
	Else
    ...
    If path_program <> "" Then
        ...
        If isInputName Then
            ...
            strMsg = """" & path_program & """ wurde beendet !"
            strTitle = "Exit Process"
